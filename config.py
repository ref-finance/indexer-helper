...
try:
    from db_info import TRXX_API_KEY, TRXX_API_SECRET, FRONTEND_API_SECRET, THIRDPARTY_WEBHOOK_URL
except ImportError:
    TRXX_API_KEY = ""
    TRXX_API_SECRET = ""
    FRONTEND_API_SECRET = ""
...
class Cfg:
    ...
    NETWORK = {
        ...
        "TESTNET": {
            ...
            "ORDERLY_CONTRACT": "asset-manager.orderly.testnet",
            "EVM_MPC_CONTRACT": "evm_mpc_addr_agent.testnet",
        ...
        "MAINNET": {
            ...
            "EVM_MPC_CONTRACT": "evm_mpc_addr_agent.stg.ref-dev-team.near",
            ...
            "REDIS_BURROW_TOKEN_METADATA_KEY": "BURROW_TOKEN_METADATA_MAINNET",
